...
public:
  explicit InitialDockThread(
    rclcpp_action::Client<opennav_docking_msgs::action::DockRobot>::SharedPtr & dock_client,
    rclcpp_action::Client<opennav_docking_msgs::action::UndockRobot>::SharedPtr & undock_client)
...
private:
  ...
  rclcpp_action::Client<opennav_docking_msgs::action::UndockRobot>::SharedPtr undock_client_;
